...
export const dynamicPrompts: Record<string, { title: string; description: string; timeLimit: number; goal: string; guide: string }> = {
  ...
  fogcatcher: {
    ...
    guide: '【聞かれていること】：今、あんたの頭の中にある「すべて」。\n【答えるべきこと】：キレイな文章じゃなくていい。単語の羅列でも、愚痴でも構わない。\n【具体的な行動】：文法も誤字も無視して、3分間ひたすらキーボードを打ち続けろ！考える前に書き出せ！'
  },
  whysos: {
    title: 'Why So（なぜなぜ分析）',
    ...
    guide: '【聞かれていること】：目の前の問題の「本当の原因」。\n【答えるべきこと】：「なぜ？」に対する答えを出し、さらにその答えに「なぜ？」を5回繰り返した結果。\n【具体的な行動】：「やる気がない」なんてのは逃げだ。泥臭い本音が出るまで「なぜ」を繰り返せ！'
  },
  sowhat: {
    title: 'So What?（つまり何？）',
    ...
    guide: '【聞かれていること】：その事実を通じて、結局「何が言えるのか」。\n【答えるべきこと】：事実の裏側にある「普遍的なルール」や「自分なりの教訓」。\n【具体的な行動】：「テレビが面白い」→「つまり人の関心は〇〇だ」。ただの感想から脱却して、本質を抜き出せ！'
  },
  '5w1h': {
    title: '5W1H 展開',
    ...
    guide: '【聞かれていること】：フワッとした情報を「具体的な計画」にすること。\n【答えるべきこと】：誰が、何を、いつ、どこで、なぜ、どのようにやるか。\n【具体的な行動】：「いつ」「どこで」から絶対に逃げるな。5分以内に完璧に埋めて、今すぐ動ける状態にしろ！'
  },
  'prep': {
    title: 'PREP法',
    ...
    guide: '【聞かれていること】：あんたの「主張」とその「正当性」。\n【答えるべきこと】：最初に結論、次にその理由、そして誰でもわかる具体例、最後に念押しの結論。\n【具体的な行動】：最初は「結論から言うと」で始めろ！この4ステップの型に無理やり当てはめろ！'
  },
  'abduction-lens': {
    ...
    guide: '【聞かれていること】：画像の裏で起きている「事件の真相」。\n【答えるべきこと】：1.画面に見える事実、2.それが起きている理由の妄想、3.その妄想を裏付ける画像内の証拠。\n【具体的な行動】：画像の隅々まで見ろ。「ここに〇〇が落ちてるから、犯人は××だ！」と自信満々に言い切れ！'
  },
  analogy: {
    ...
    guide: '【聞かれていること】：今の課題を「別の何か」に置き換えた解決策。\n【答えるべきこと】：別の分野で似た構造を持つ事象と、そこから得られるヒント。\n【具体的な行動】：カレー作りとプロジェクト運営はどう似ている？違う世界から無理やり「成功パターン」をパクってこい！俺から先に答えは言わねえぞ。'
  },
  'metaphor-coach': {
    ...
    guide: '【聞かれていること】：平凡な言葉を「刺さる例え話」に進化させること。\n【答えるべきこと】：対象の分解、共通点の抽出、そして誰もがパッと情景を思い浮かべる比喩の完成形。\n【具体的な行動】：俺が1段ずつステップを出すから、回答例をヒントに焦らず答えろ。最後に俺を唸らせる表現を作れ！'
  }
};
